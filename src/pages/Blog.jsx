...
export default function Blog() {
  ...
  return (
    <>
      <PageIntro eyebrow="Blog" title="Insights on AI-powered growth">
        <p>
          Practical articles on organic SEO, content automation, and how UK
          small businesses are using AI to grow without the agency price tag.
        </p>
      </PageIntro>
